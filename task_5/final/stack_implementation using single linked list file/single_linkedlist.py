...
if __name__=='__main__':
    ...
    if op == "add":
        ...
        index = int(input())
        element = int(input())
        if Sll.addToIndex(index,element) == 0 :
            print("Error")
        else:
            Sll.printList(Sll.head)

    elif op =="get":
        print(Sll.get(int(input())))

    elif op =="set":
        index = int(input())
        element = int(input())
        if Sll.set(index,element) == "Error":
            print("Error")
        else:
            Sll.printList(Sll.head)
        ...
        index1 = int(input())
        index2 = int(input())
        if (index2>=index1 and index1>=0 and index2<Sll.size()):
            Sll.sublist(index1,index2)
        else:
            print("Error")
    
    elif op =="contains":
        print(Sll.contains(int(input())))
